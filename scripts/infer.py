...
def parse_args():
    p = argparse.ArgumentParser(description="Inference with trained MedNeXt checkpoint")
...
def main():
    ...
    logger = build_logger(out_dir / "infer.log")
    ...
    for batch in tqdm(infer_loader, desc="Inference", leave=False):
    ...
    logger.info("Inference done. Outputs at: %s", out_dir)
